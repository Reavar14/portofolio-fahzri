<template>
  <footer class="relative border-t border-white/5 py-8">
    <div class="absolute inset-0 bg-dark-800/50 pointer-events-none" />
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
        <!-- Logo -->
        <div class="flex items-center gap-2">
          <div class="w-7 h-7 rounded-lg bg-gradient-to-br from-primary-500 to-accent-purple flex items-center justify-center font-black text-white text-sm">
            F
          </div>
